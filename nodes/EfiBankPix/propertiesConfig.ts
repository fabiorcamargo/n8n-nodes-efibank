...
import { recConfig } from './properties/recConfig';
...
export const propertiesConfig: INodeProperties[] = [
...

  {
    ...
    options: [
      { name: 'Criar recorrência de PIX automático', value: 'pixCreateRecurrence' },
      { name: 'Consultar recorrência de PIX automático', value: 'pixDetailRecurrence' },
      { name: 'Revisar recorrência de PIX automático', value: 'pixUpdateRecurrence' },
      { name: 'Consultar lista de recorrências de PIX automático', value: 'pixListRecurrences' },
      { name: 'Criar solicitação de confirmação de recorrência', value: 'pixCreateRecurrenceRequest' },
      { name: 'Consultar solicitação de recorrência', value: 'pixDetailRecurrenceRequest' },
      { name: 'Revisar solicitação de confirmação de recorrência', value: 'pixUpdateRecurrenceRequest' },
      { name: 'Criar cobrança de PIX automático (com txid)', value: 'pixCreateAutoCharge' },
      { name: 'Criar cobrança de PIX automático (sem txid)', value: 'pixCreateAutoChargeImmediate' },
      { name: 'Revisar cobrança de PIX automático', value: 'pixUpdateAutoCharge' },
      { name: 'Consultar cobrança de PIX automático', value: 'pixDetailAutoCharge' },
      { name: 'Consultar lista de cobranças de PIX automático', value: 'pixListAutoCharges' },
      { name: 'Solicitar retentativa de PIX automático', value: 'pixRetryAutoCharge' },
    ],
    default: 'pixCreateRecurrence',
    description: 'Selecione o endpoint que você deseja utilizar',
    displayOptions: {
      show: { transactionType: ['rec'] },
    },
  },
